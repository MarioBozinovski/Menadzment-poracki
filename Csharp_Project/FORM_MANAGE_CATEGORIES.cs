...
namespace Csharp_Project
{
    public partial class FORM_MANAGE_CATEGORIES : Form
    {
        ...
        private void BTN_DELETE_CTG_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Dali navistina sakate da ja izbrisete ovaa kategorija", "Izbrisi kategorija", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        DGV_CATEGORIES.DataSource = table;
                        MessageBox.Show("Kategorijata e uspesno izbrisana", "Izbrisi kategorija");
                        TB_CATG_ID.Text = "";
                        TB_CATG_NAME.Text = "";
                    }
        ...
        private void BTN_UPDATE_CTG_Click(object sender, EventArgs e)
        {
            if (TB_CATG_ID.Text != string.Empty || TB_CATG_NAME.Text != string.Empty)
           {
               try
               {
                   ...
                   MessageBox.Show("Kategorijata e uspesno azurirana", "Azuriraj kategorija", MessageBoxButtons.OK, MessageBoxIcon.Information);
                   DGV_CATEGORIES.DataSource = category.getCategories();
               }
        ...
        private void FORM_MANAGE_CATEGORIES_Load(object sender, EventArgs e)
        {
